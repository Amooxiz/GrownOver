        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Materials_BaseItems_Id",
                        column: x => x.Id,
                        principalTable: "BaseItems",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                name: "BaseItemHideouts",
                columns: table => new
                {
                    BaseItemId = table.Column<int>(type: "int", nullable: false),
                    HideoutId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BaseItemHideouts", x => new { x.BaseItemId, x.HideoutId });
                    table.ForeignKey(
                        name: "FK_BaseItemHideouts_BaseItems_BaseItemId",
                        column: x => x.BaseItemId,
                        principalTable: "BaseItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BaseItemHideouts_HideOuts_HideoutId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Inventories_Armors_ArmorId",
                        column: x => x.ArmorId,
                        principalTable: "Armors",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Inventories_Foods_FoodId",
                        column: x => x.FoodId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ingenuity = table.Column<int>(type: "int", nullable: true),
                    Charisma = table.Column<int>(type: "int", nullable: true),
                    Awereness = table.Column<int>(type: "int", nullable: true),
                    Experience = table.Column<int>(type: "int", nullable: true),
                    HideOutId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_HideOuts_HideOutId",
                        column: x => x.HideOutId,
                        principalTable: "HideOuts",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BaseItemHideouts_HideoutId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Inventories_ArmorId",
                table: "Inventories",
                column: "ArmorId");

            migrationBuilder.CreateIndex(
                name: "IX_Inventories_FoodId",
                table: "Inventories",
                column: "FoodId");
